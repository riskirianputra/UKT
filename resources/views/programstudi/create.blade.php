                  ...
                  <div class="card">    
                    <div class="card-body">                                                                    
                        ...
                        <div class="form-group{{ $errors->has('idProdi') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idProdi" type="text" class="form-control" name="idProdi" value="{{ old('idProdi') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('idFakultas') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idFakultas" type="text" class="form-control" name="idFakultas" value="{{ old('idFakultas') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('namaPendekFak') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="namaPendekFak" type="text" class="form-control" name="namaPendekFak" value="{{ old('namaPendekFak') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('idProdiSia') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idProdiSia" type="text" class="form-control" name="idProdiSia" value="{{ old('idProdiSia') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('kodeProdiUniv') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="kodeProdiUniv" type="text" class="form-control" name="kodeProdiUniv" value="{{ old('kodeProdiUniv') }}" required>
                         ...
                         <div class="form-group{{ $errors->has('kodeProdiDikti') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="kodeProdiDikti" type="text" class="form-control" name="kodeProdiDikti" value="{{ old('kodeProdiDikti') }}" required>
                         ...
                         <div class="form-group{{ $errors->has('namaProgramStudi') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="namaProgramStudi" type="text" class="form-control" name="namaProgramStudi" value="{{ old('namaProgramStudi') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('idJenjang') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idJenjang" type="text" class="form-control" name="idJenjang" value="{{ old('idJenjang') }}" required>
