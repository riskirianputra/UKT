    ...
    <div class=" font-weight-bold">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/home">Home</a></li>
          <li class="breadcrumb-item"><a href="{{ route('programstudi.index') }}">Prodi</a></li>
        <li class="breadcrumb-item active" aria-current="page">Edit</li>
      </ol>
</div>
<form action="{{ route('programstudi.update', $data->id) }}" method="post">
    {{ csrf_field() }}
    {{ method_field('put') }}
<div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group{{ $errors->has('idProdi') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idProdi" type="text" class="form-control" name="idProdi" value="{{ $data->idProdi }}" required>
                        ...
                        <div class="form-group{{ $errors->has('idFakultas') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idFakultas" type="text" class="form-control" name="idFakultas" value="{{ $data->idFakultas }}" required>
                        ...
                        <div class="form-group{{ $errors->has('namaPendekFak') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="namaPendekFak" type="text" class="form-control" name="namaPendekFak" value="{{ $data->namaPendekFak }}" required>
                        ...
                        <div class="form-group{{ $errors->has('idProdiSia') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idProdiSia" type="text" class="form-control" name="idProdiSia" value="{{ $data->idProdiSia }}" required>
                        ...
                        <div class="form-group{{ $errors->has('kodeProdiUniv') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="kodeProdiUniv" type="text" class="form-control" name="kodeProdiUniv" value="{{ $data->kodeProdiUniv }}" required>
                         ...
                         <div class="form-group{{ $errors->has('kodeProdiDikti') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="kodeProdiDikti" type="text" class="form-control" name="kodeProdiDikti" value="{{ $data->kodeProdiDikti }}" required>
                         ...
                         <div class="form-group{{ $errors->has('namaProgramStudi') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="namaProgramStudi" type="text" class="form-control" name="namaProgramStudi" value="{{ $data->namaProgramStudi }}" required>
                        ...
                        <div class="form-group{{ $errors->has('idJenjang') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idJenjang" type="text" class="form-control" name="idJenjang" value="{{ $data->idJenjang }}" required>
