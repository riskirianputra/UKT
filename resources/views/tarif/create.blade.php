                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group{{ $errors->has('idPeriode') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idPeriode" type="text" class="form-control" name="idPeriode" value="{{ old('idPeriode') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('idJalur') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idJalur" type="text" class="form-control" name="idJalur" value="{{ old('idJalur') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('idProgramStudi') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idProgramStudi" type="text" class="form-control" name="idProgramStudi" value="{{ old('idProgramStudi') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('idJenisBiaya') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idJenisBiaya" type="text" class="form-control" name="idJenisBiaya" value="{{ old('idJenisBiaya') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('jumlah') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('syarat') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="syarat" type="text" class="form-control" name="syarat" value="{{ old('syarat') }}" required>
