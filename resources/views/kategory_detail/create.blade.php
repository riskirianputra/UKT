...
<form method="POST" action="{{ route('kategory_detail.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
                    ...
                    <div class="card-header bg-info">TAMBAH KATEGORY DETAIL BOBOT</div>
                      <div class="card-body">                         
                        ...
                        <div class="form-group{{ $errors->has('isiKategory') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="isiKategory" type="text" class="form-control" name="isiKategory" value="{{ old('isiKategory') }}" required>
                         ...
                         <div class="form-group{{ $errors->has('poin') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="poin" type="text" class="form-control" name="poin" value="{{ old('poin') }}" required>
                                @if ($errors->has('poin'))
                                    <span class="help-block">
