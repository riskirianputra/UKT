...
<div class="col-sm-12 col-lg-offset-1">
  <h3><i class="fa fa-money"></i> KATEGORY DETAIL BOBOT <a href="{{ route('kategory_detail.create') }}" class="btn btn-info pull-right"> +Add </a></h3>
                                ...
                                <div class="btn-group dropright ">
                                    ...
                                    <i class="fa fa-cogs" aria-hidden="true"></i> <span class="sr-only">Toggle Dropdown</span>
                                      ...
                                      <div class="dropdown-menu">                                                                                   
                                        <a href="{{route('kategory_detail.edit', $data->id)}}"  class="dropdown-item">Edit</a>
                                       <form action="{{ route('kategory_detail.destroy', $data->id) }}" class="pull-left"  method="post">
                                      {{ csrf_field() }}
                                      {{ method_field('delete') }}
