...
<form action="{{ route('jenjang.update', $data->idJenjang) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('put') }}
    <div class="row">
                <div class="col-12">
                  <div class="card">
                    ...
                    <div class="form-group{{ $errors->has('namaJenjang') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="namaJenjang" type="text" class="form-control" name="namaJenjang" value="{{ $data->namaJenjang }}" required>
