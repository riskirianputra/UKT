                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group{{ $errors->has('isiInformasi') ? ' has-error' : '' }}">
                            <label for="isiInformasi" class="col-md-4 control-label">INFORMASI</label>
                            <div class="col-md-12">
                                <textarea class="ckeditor" id="ckeditor" name="isiInformasi"></textarea>
                         ...
                         <div class="form-group{{ $errors->has('pengunguman') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <textarea class="ckeditor" id="ckeditor" name="pengunguman"></textarea>
                         ...
                         <div class="form-group{{ $errors->has('peringatan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <textarea class="ckeditor" id="ckeditor" name="peringatan"></textarea>
...
<script>
    CKEDITOR.replace('isiInformasi','pengunguman');
</script>