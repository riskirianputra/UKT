                  ...
                  <div class="card">
                      <div class="card-body">
                        ...
                        <div class="form-group{{ $errors->has('namaFakultas') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="namaFakultas" type="text" class="form-control" name="namaFakultas" value="{{ old('namaFakultas') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('idFakultasSia') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idFakultasSia" type="text" class="form-control" name="idFakultasSia" value="{{ old('idFakultasSia') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('dbFakultas') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="dbFakultas" type="text" class="form-control" name="dbFakultas" value="{{ old('dbFakultas') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('urutanNim') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="urutanNim" type="number" maxlength="4" class="form-control" name="urutanNim" value="{{ old('urutanNim') }}" required>
