                    ...
                    <div class="card-body">
                      <h4 class="card-title"></h4>
                        ...
                        <div class="form-group{{ $errors->has('namaFakultas') ? ' has-error' : '' }}">
                            <label for="namaFakultas" class="col-md-6 control-label">NAMA FAKULTAS</label>
                            <div class="col-md-12">
                                <input id="namaFakultas" type="text" class="form-control" name="namaFakultas" value="{{ $data->namaFakultas }}" required readonly="">
                        ...
                        <div class="form-group{{ $errors->has('idFakultasSia') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="idFakultasSia" type="text" class="form-control" name="idFakultasSia" value="{{ $data->idFakultasSia}}" required readonly="">
                        ...
                        <div class="form-group{{ $errors->has('dbFakultas') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="dbFakultas" type="text" class="form-control" name="dbFakultas" value="{{ $data->dbFakultas }}" required readonly="">
                        ...
                        <div class="form-group{{ $errors->has('urutanNim') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="urutanNim" type="number" maxlength="4" class="form-control" name="urutanNim" value="{{ $data->urutanNim }}" required readonly="">
